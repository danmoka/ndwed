        ...
        <Section className="text-center">
          ...
          <div className="flex items-center justify-center">
            <span className="relative inline-flex">
              <a href="#transfer" className="inline-flex items-center rounded-md bg-white px-4 py-2 text-sm leading-6 font-semibold text-gray-200 ring-1 ring-gray-900/10 transition duration-150 ease-in-out bg-white/5 ring-white/20">
